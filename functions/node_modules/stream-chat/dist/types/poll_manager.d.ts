...
import type { CreatePollData, DefaultGenerics, ExtendableGenerics, PollSort, QueryPollsFilters, QueryPollsOptions } from './types';
...
export declare class PollManager<SCG extends ExtendableGenerics = DefaultGenerics> {
    ...
    hydratePollCache: (messages: FormatMessageResponse<SCG>[], overwriteState?: boolean | undefined) => void;
